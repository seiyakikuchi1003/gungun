...
const styles = StyleSheet.create({
  ...
  saveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, minHeight: 56, borderRadius: radius.pill, backgroundColor: colors.green, paddingVertical: 8, paddingHorizontal: 14 },
  saveBtnOff: { backgroundColor: colors.textPlaceholder, opacity: 0.6 },
  saveText: { flexShrink: 1, textAlign: 'center', fontFamily: fonts.bold, fontSize: 17, color: colors.white, },
