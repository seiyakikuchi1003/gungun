...
const styles = StyleSheet.create({
  ...
  searchRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: colors.card, borderRadius: radius.pill, paddingHorizontal: spacing.md, minHeight: 42, marginHorizontal: 20, marginBottom: spacing.sm, ...shadows.soft, paddingVertical: 6 },
  searchInput: { flex: 1, fontFamily: fonts.medium, fontSize: 14.5, color: colors.textPrimary },
  filtersRow: { minHeight: 60, paddingVertical: 8 },
  filters: { paddingHorizontal: 20, gap: spacing.sm, alignItems: 'center', paddingVertical: 10 },
  chip: { paddingHorizontal: 16, minHeight: 38, borderRadius: radius.pill, backgroundColor: colors.card, justifyContent: 'center', paddingVertical: 6 },
