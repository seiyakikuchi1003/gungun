...
-- ── お届け先 ───────────────────────────────────────────────
-- 発送・受け取りの画面は住所が無いと成立しないので、デモ用に入れておく。
-- 実在しない番地を使っている（デモであることが分かるようにしている）。
insert into addresses (user_id, last_name, first_name, phone, postal_code, prefecture, city, street, building) values
  ('00000000-0000-0000-0000-0000000000a1', 'デモ', 'はる',   '09000000001', '1500001', '東京都', '渋谷区', '神宮前0-0-1', 'ぐんぐんデモ101'),
  ('00000000-0000-0000-0000-0000000000a2', 'デモ', 'めたん', '09000000002', '1600022', '東京都', '新宿区', '新宿0-0-2', 'ぐんぐんデモ202'),
  ('00000000-0000-0000-0000-0000000000a3', 'デモ', 'さくら', '09000000003', '1050011', '東京都', '港区',   '芝公園0-0-3', null),
  ('00000000-0000-0000-0000-0000000000a4', 'デモ', 'ゆう',   '09000000004', '1310045', '東京都', '墨田区', '押上0-0-4', 'ぐんぐんデモ404'),
  ('00000000-0000-0000-0000-0000000000a5', 'デモ', 'たくさん','09000000005', '2200012', '神奈川県', '横浜市西区', 'みなとみらい0-0-5', null),
  ('00000000-0000-0000-0000-0000000000a6', 'デモ', 'けんた', '09000000006', '5300001', '大阪府', '大阪市北区', '梅田0-0-6', 'ぐんぐんデモ606')
