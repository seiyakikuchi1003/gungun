...
const rawItems: RawItem[] = [
  ...
  { id: 'giftcard', name: 'ハンドクリーム 3本セット', category: 'コスメ・美容', condition: '新品・未使用', description: '未開封のまま置いてありました。香り違いの3本セットです。', image: img('hand1'), images: [img('hand1')], local: P.perfume, localImages: [P.perfume], ownerId: 'metan', waterCount: 4, likeCount: 19, treeCount: 4, status: 'growing' },
  ...
  { id: 'w-gift', name: 'ステンレスボトル', category: '日用品・雑貨・文具', condition: '未使用に近い', description: '保温・保冷どちらもいけます。数回だけ使いました。', image: img('bottle1'), images: [img('bottle1')], local: P.coffee, localImages: [P.coffee], ownerId: 'kenta', waterCount: 1, likeCount: 2, treeCount: 0, status: 'growing', parentId: 'speaker', rootId: 'speaker', depth: 1 },
  ...
  //   ハンドクリーム(めたん) ├ AirPods(はる)  └ ブランド財布(さくら)
